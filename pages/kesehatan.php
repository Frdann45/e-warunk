...
try {
    if ($searchQuery !== '') {
        $stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'Kesehatan' AND name LIKE ? ORDER BY id ASC");
        $stmt->execute(['%' . $searchQuery . '%']);
    } else {
        $stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'Kesehatan' ORDER BY id ASC");
        $stmt->execute();
    }
